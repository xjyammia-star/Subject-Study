      ...
      <div className="bg-surface-3 border border-border rounded-lg p-5">
        ...
        <div className="space-y-2">
          {section.opts.map((opt, idx) => {
            ...
            if (chosen === null) {
              classes +=
                "border-border text-gray-300 hover:border-accent hover:text-accent cursor-pointer bg-surface-2";
              ...
              classes +=
                "border-border text-gray-600 cursor-default bg-transparent";
            }
        ...
        {chosen !== null && (
          <div
            className={`mt-4 p-4 rounded-lg text-[15px] leading-[1.7] ${
              isCorrect
